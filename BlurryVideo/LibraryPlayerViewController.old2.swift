...
//    var playerToolbar: LibraryPlayerToolbar!
//    
//    let player = AVPlayer()
//    
...
//        
//        playerToolbar = LibraryPlayerToolbar()
...
//        playerToolbar.closeButton.addTarget(self, action: #selector(returnToLibrary), for: .touchUpInside)
...
//    }
//    
//    @objc func returnToLibrary() {
//        guard let libraryVC = parent as? LibraryViewController else { return }
//        if let _ = playerItem {
//            player.pause()
//            let snapshot = takePlayerSnapshot(at: player.currentTime())
//            libraryVC.transition(from: self, withTransitionImage: snapshot)
//        } else {
//            libraryVC.transition(from: self, withTransitionImage: transitionView?.image)
//        }
//    }
//}
//
