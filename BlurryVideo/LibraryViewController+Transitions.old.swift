////
////  LibraryViewController+Transitions.swift
////  BlurryVideo
////
...
//    
//    func transition(to playerVC: LibraryPlayerViewController, withTransitionImage transitionImage: UIImage) {
//        logIN()
...
//        let selectedCell = collectionView.cellForItem(at: selectedIndexPath!) as! LibraryCell
...
//    }
//    
//    func transition(from playerVC: LibraryPlayerViewController, withTransitionImage transitionImage: UIImage?) {
//        logIN()
...
//        logDebug("playerToolbar.frame = \(playerToolbar.frame)")
//        view.addSubview(playerToolbar)
//        
