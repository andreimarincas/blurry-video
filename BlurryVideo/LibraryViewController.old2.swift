...
//    }
//    
////    func loadPlayerItemAsync(forVideo asset: PHAsset, playerVC: LibraryPlayerViewController) {
////        logIN()
...
////            self.imageManager.requestPlayerItem(forVideo: asset, options: requestOptions)
...
////                    } else {
////                        logError("Failed to load player item for asset.")
...
//                        //weakSelf.loadPlayerItemAsync(forVideo: currentAsset, playerVC: playerVC)
