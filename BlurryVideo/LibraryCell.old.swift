...
//                durationLabel.text = LibraryCell.durationFormatter.string(from: duration)
...
//}
//
//class LibraryHeaderCell: UICollectionReusableView {
//}
//
//class LibraryFooterCell: UICollectionReusableView {
//    
